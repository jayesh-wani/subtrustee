...
import {
  ...
  GET_TRANSACTIONS_OF_SETTLEMENT,
} from "../../../Qurries";
...
function TransactionsOfSettlement() {
  ...
  useEffect(() => {
    ...
    if (
      data?.getSettlementsTransactions?.settlements_transactions &&
      data?.getSettlementsTransactions?.settlements_transactions.length > 0
    ) {
      setAdditionalData(
              ...
              <div className="flex justify-between items-center my-4 px-4">
                <button
                  onClick={async () => {
                    ...
                    if (data?.getSettlementsTransactions?.cursor === "N/A") {
                ...
                <button
                  onClick={async () => {
                    ...
                    if (
                      data?.getSettlementsTransactions?.cursor !== null &&
                      data?.getSettlementsTransactions?.cursor !== "N/A"
                    ) {
